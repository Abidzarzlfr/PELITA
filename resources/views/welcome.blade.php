  ...
  <head>
    ...
    <style>
      .carousel-item img {
        ...
        object-fit: cover; /* This property ensures the image covers the specified dimensions */
      }
    </style>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary-subtle">
      <div class="container">
        ...
        <div
          class="fitur-navbar collapse navbar-collapse"
      ...
      <div id="carouselExampleCaptions" class="carousel slide mt-5 mb-5">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="https://casf.com.au/wp-content/uploads/2022/01/silver_grey.png"
              class="d-block w-100"
              alt="..."
            />
